...
const integrationCards = [
    { type: "Vector", name: "Pinecone", description: "Fully-managed vector database for AI apps", provider: "Pinecone Systems" },
    { type: "Relational", name: "PostgreSQL", description: "Advanced open source relational database", provider: "PostgreSQL Global Development Group" },
    { type: "Graph", name: "Neo4j", description: "Graph database management system", provider: "Neo4j, Inc." },
    { type: "Nosql", name: "MongoDB", description: "Source-available cross-platform document-oriented database", provider: "MongoDB Inc." },
    { type: "Vector", name: "Qdrant", description: "Vector Database for the next generation of AI apps", provider: "Qdrant" },
    { type: "Relational", name: "MySQL", description: "Open-source relational database management system", provider: "Oracle" },
];
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-5 w-full">
                            <div className="flex flex-col gap-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h1 className="text-2xl font-semibold text-text-primary leading-8">Databases</h1>
                                </div>
                                <p className="max-w-[640px] text-base text-text-tertiary leading-6">
                                    Easily connect, manage, and scale the top databases for your specific use cases.
                                </p>
                            </div>
