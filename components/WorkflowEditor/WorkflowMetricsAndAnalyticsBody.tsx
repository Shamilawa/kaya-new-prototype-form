...
import styles from "./WorkflowMetricsAndAnalyticsBody.module.css";
import MetricCard from "../MetricCard";
import { 
    AlertCircle, ArrowRight, X, BarChart3, 
    Calendar, ArrowUpRight, Search, ChevronDown,
    TrendingUp, TrendingDown
} from "lucide-react";
import Image from "next/image";

interface WorkflowMetricsAndAnalyticsBodyProps {
    workspaceId: string;
    iflowId: string;
    iflowName: string;
}

const WorkflowMetricsAndAnalyticsBody: React.FC<WorkflowMetricsAndAnalyticsBodyProps> = ({ 
    workspaceId, 
    iflowId, 
    iflowName 
}) => {
    return (
        <div className={styles.groupParent}>
            <div className={styles.alertParent}>
                            ...
                            <div className={styles.alertContent2}>
                                ...
                                <div className={styles.alertTextAndSupportingText}>
                                    ...
                                    <div className={styles.alertSupportingText}>
                                        Offer Recommender has failed 6 of its last 10 runs. Last error: API timeout
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={styles.headerContainer}>
                        <div className={styles.headerContent}>
                            <div className={styles.iconsParent}>
                                ...
                                <div className={styles.headerTitle}>Workflow Metrics & Analytics</div>
                            </div>
                            <div className={styles.headerSupportingText}>
                                Track performance, activity, and reliability for {iflowName}.
                            </div>
                        </div>
                    ...
                    <div className={styles.metricItemParent}>
                        <div className={styles.metricItem}>
                            <div className={styles.headingWrapper}>
                                <div className={styles.heading}>Most Used Agent</div>
                            </div>
                            <div className={styles.metricContent}>
                                <div className={styles.numberAndBadge}>
                                    <div className={styles.number}>CLV Predictor</div>
                                    <div className={styles.number2}>Xinfinity CLV Prediction</div>
                        ...
                        <div className={styles.metricItem}>
                            <div className={styles.headingWrapper}>
                                <div className={styles.heading}>Slowest Avg Response</div>
                            </div>
                            <div className={styles.metricContent}>
                                <div className={styles.numberAndBadge}>
                                    <div className={styles.number}>Churn Classifier</div>
                                    <div className={styles.text14}>
                                        <b>2s response time</b>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* Agent Summary Table */}
                <div className={styles.pageHeaderParent}>
                    <div className={styles.text20}>Agent Summary Table</div>
                        ...
                        <div className={styles.tableContainer}>
                            <div className={styles.table}>
                                <div className={`${styles.tableRow} ${styles.tableHeader}`}>
                                    <div className={styles.tableCell}>Agent name</div>
...
export default WorkflowMetricsAndAnalyticsBody;
