        ...
        <div className={styles.startNodeContainer}>
            <div className={styles.startNodeHeader}>
                ...
                <div className={styles.startNodeTitleGroup}>
                    ...
                    <div className={styles.startNodeSubtitle}>
                        Workflow trigger
                    </div>
                </div>
            </div>
...
const GhostNode = () => {
    return (
        <div className={styles.ghostNodeContainer}>
            <div className={styles.ghostNodeTitle}>
    ...
    <div className={styles.basicAgentNodeContainer}>
        ...
        <div className={styles.basicAgentNodeGroup}>
            ...
            <div className={styles.basicAgentNodeBadgeGroup}>
                ...
                <div className={styles.basicAgentBadgeSecondary}>
                    {"{Attribute}"}
                </div>
                <div className={styles.basicAgentBadgeSecondary}>
                    {"{Attribute}"}
...
const WorkflowEditorContent: React.FC = () => {
    ...
    const workspaceAgents = [
        ...
        },
        {
            title: "Support Agent",
            description:
                "Handles customer inquiries and technical support tickets",
        },
        {
            title: "Marketing Lead",
            description:
                "Specializes in campaign optimization and lead generation",
        },
        {
            title: "Data Analyst",
            description:
                "Processes large datasets to provide actionable insights",
        },
        {
            title: "Finance Bot",
                        ...
                        <div className={styles.bodyContentInner}>
                            <div className={styles.headerParent}>
                                ...
                                <div className={styles.badgeParent}>
                                    ...
                                    <div className={styles.saved2minsAgo}>
                                        Saved 2mins ago
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={styles.bodyContentChild}>
                            <div className={styles.frameParent}>
                                <div className={styles.frameGroup}>
                                    <div
                                        className={styles.horizontalTabsWrapper}
                                    >
